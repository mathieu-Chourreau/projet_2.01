...
void Lecteur::chargerDiaporama()
{
    ...
    Image* imageACharger;
    imageACharger = new Image(3, "personne", "Blanche Neige", "F:\\Cours_IUT\\SAE_2.01\\cartesDisney\\Disney_4.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(2, "personne", "Cendrillon", "F:\\Cours_IUT\\SAE_2.01\\cartesDisney\\Disney_21.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(4, "animal", "Mickey", "F:\\Cours_IUT\\SAE_2.01\\cartesDisney\\Disney_19.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(1, "personne", "Grincheux", "F:\\Cours_IUT\\SAE_2.01\\cartesDisney\\Disney_31.gif");
    _diaporama.push_back(imageACharger);
